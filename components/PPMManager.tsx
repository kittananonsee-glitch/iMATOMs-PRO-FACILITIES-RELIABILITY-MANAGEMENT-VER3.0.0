      ...
      <nav className="w-64 border-r border-cyan-500/20 bg-black/40 flex flex-col p-4 shrink-0">
        <div className="mb-10 px-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="font-display text-xl font-bold text-cyan-400 uppercase">PPM</h1>
          </div>
          <p className="text-[10px] text-white/40 tracking-widest uppercase">Reliability Module</p>
        </div>

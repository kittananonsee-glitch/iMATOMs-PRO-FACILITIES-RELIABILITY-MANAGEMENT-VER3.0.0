    ...
    <div className="flex h-full overflow-hidden bg-[#0a0e17] text-white">
      ...
      <nav className="w-64 border-r border-white/10 bg-black/40 flex flex-col p-4 shrink-0">
        <div className="mb-10 px-4">
          <h1 className="font-display text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-cyan-400 uppercase">Ver32</h1>
          <p className="text-[10px] text-white/40 tracking-widest uppercase">Asset Management</p>
        </div>
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="pt-4 border-t border-white/5 mt-4">
            <button onClick={onBack} className="flex items-center gap-3 p-3 w-full text-white/60 hover:text-white hover:bg-red-500/10 rounded-xl transition-all">
              ...
              <span className="text-xs font-bold uppercase">Back to Main</span>
            </button>
          </div>
        </div>
      </nav>

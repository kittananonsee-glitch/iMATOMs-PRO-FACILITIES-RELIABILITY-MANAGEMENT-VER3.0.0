...
const APPSHEET_DATA: AppSheetRecord[] = [
  // ViMUT Hospital
  { hospital: "ViMUT Hospital", category: "Dashboards & Analytics", name: "ViMUT_Dashboard_XRAY Temp", url: "https://www.appsheet.com/start/0788eed4-99c2-4cf0-9dca-26d6f8cc077f", icon: "📊", color: "#4CAF50", status: "Deployed" },
      ...
      <header className="px-4 py-4 sm:px-6 sm:py-6 bg-black/80 border-b border-purple-500/20 backdrop-blur-3xl sticky top-0 z-30 shadow-2xl shrink-0">
        <div className="flex items-center gap-3 mb-5">
           ...
           <div className="min-w-0 flex-1">
              <h1 className="font-display text-base sm:text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 truncate">MOBILE APP HUB</h1>
              <p className="text-[8px] sm:text-[9px] uppercase tracking-widest text-white/40 font-black truncate">AppSheet Field System</p>
           </div>
        </div>
        ...
        <div className="flex p-1 bg-black/40 rounded-2xl mb-5 border border-white/5 max-w-2xl mx-auto shadow-inner">
          <button 
            ...
            className={`flex-1 py-2.5 rounded-xl text-[10px] sm:text-xs font-black uppercase tracking-widest transition-all truncate px-2 ${

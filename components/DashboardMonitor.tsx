...
const MONITOR_SOURCES: MonitorSource[] = [
  ...
  { id: 'vm-2', name: 'VM SAFETY', url: 'https://lookerstudio.google.com/embed/reporting/b865dbca-accb-49bc-a306-614245aef600/page/S0IMF', building: 'ViMUT Hospital (VM)', icon: '🛡️' },
